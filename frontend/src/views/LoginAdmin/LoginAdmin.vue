    ...
    <div class="login">
        <div class="wrap">
            <div class="col_1_of_login span_1_of_login">
                <h4 class="title">Administrateur</h4>
                <h5 class="sub_title">
                    
                </h5>
                <p>En tant qu'administrateur ou gestionnaire de produit, vous pouvez gérer les produits, gérer les bon de commandes passer par le client.</p>
                <!-- <div class="button1">
            ...
            <div class="col_1_of_login span_1_of_login">
                <div class="login-title">
                    <h4 class="title">Se connecter en tant qu'administrateur</h4>
...
<script>
    ...
    export default {
        ...
        methods:{
            onSubmit() {
                var link = Vue.BASE_URL+"/utilisateur/loginaction";
                var that = this;
                axios.post(link, $("#formulaire").serialize()).then(function (response) {
                    ...
                    if (response.data.error === "") {
                        ...
                        // location.reload(Vue.BASE_URL+"/produit");
                        that.$router.push("/produit");
