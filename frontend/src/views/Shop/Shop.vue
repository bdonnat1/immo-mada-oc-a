                    ...
                    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                ...
                                <div class="grid_img">
                                    <div class="css3"><img :src="BASE_URL+'/public/assets/images/pic11.jpg'" alt=""/></div>
                                    <div class="mask1">
                        ...
                        <span class="rating1">
                            ...
                            <label for="rating-input-1-1" class="rating-star"></label>&nbsp;(45)
                        </span>
                        <ul class="list2">
                            <li>
                                ...
                                <ul class="icon1 sub-icon1 profile_img">
                                    <li><a class="active-icon c1" href="#">Add To Bag </a>
                                        <ul class="sub-icon1 list">
                                            ...
                                            <li><p>Lorem ipsum dolor sit amet, consectetuer <a href="">adipiscing elit,
                                                sed
                                                diam</a></p></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                ...
                                <p class="m_2">Lorem ipsum</p>
                                <div class="grid_img">
                                    <div class="css3"><img :src="BASE_URL+'/public/assets/images/pic10.jpg'" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info">Quick View</div>
                                    </div>
                                </div>
                    ...
                    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                ...
                                <p class="m_2">Lorem ipsum</p>
                                <div class="grid_img">
                                    <div class="css3"><img :src="BASE_URL+'/public/assets/images/pic9.jpg'" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info">Quick View</div>
                                    </div>
                                </div>
                    ...
                    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                ...
                                <p class="m_2">Lorem ipsum</p>
                                <div class="grid_img">
                                    <div class="css3"><img :src="BASE_URL+'/public/assets/images/pic3.jpg'" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info">Quick View</div>
                                    </div>
                                </div>
                    ...
                    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                ...
                                <p class="m_2">Lorem ipsum</p>
                                <div class="grid_img">
                                    <div class="css3"><img :src="BASE_URL+'/public/assets/images/pic4.jpg'" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info">Quick View</div>
                                    </div>
                                </div>
                    ...
                    <div class="col_1_of_single1 span_1_of_single1"><a href="single.html">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                ...
                                <p class="m_2">Lorem ipsum</p>
                                <div class="grid_img">
                                    <div class="css3"><img :src="BASE_URL+'/public/assets/images/pic5.jpg'" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info">Quick View</div>
                                    </div>
                                </div>
                        ...
                        <a href="single.html">
                            <div class="view1 view-fifth1">
                                <div class="top_box">
                                    ...
                                    <p class="m_2">Lorem ipsum</p>
                                    <div class="grid_img">
                                        <div class="css3"><img :src="BASE_URL+'/public/assets/images/pic6.jpg'" alt=""/></div>
                                        <div class="mask1">
                                            <div class="info">Quick View</div>
                                        </div>
                                    </div>
...
<script>
    export default {
        ...
        mounted() {
            ...
            window.$().UItoTop({easingType: 'easeOutQuart',defaults});
        }
    }
</script>
