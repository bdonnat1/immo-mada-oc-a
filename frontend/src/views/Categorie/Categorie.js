...
export default {
    ...
    data: function () {
        return {
            ...
            total_data: 0,
            photos_categorie: [],
            tab_categorie_parent:[],
            recherche: "",
            titlemodal: "Nouveau Categorie",
            categorie: {
                nom_categorie: "", categoie_parent: 0, description: "", photos: '', child_categorie: [{
                    id: 0,
                    nom_categorie: '',
                    categorie_parent: 0,
                }]
    ...
    methods: {
        getParentCategorie(){
            axios.get(this.BASE_URL + "/categorie/getparentcategorie" ).then((response) => {
                this.tab_categorie_parent = response.data;
            })
        },

        getALlCategorie(){
            axios.get(this.BASE_URL + "/categorie/get" ).then((response) => {
                this.tab_categorie = response.data;
                this.getParentCategorie();
            })
        },

        PushCategorie() {
            this.categorie.child_categorie.push({id: 0, nom_categorie: '', categorie_parent: 0})
        },

        PopCategorie(index) {
            this.categorie.child_categorie.splice(index, 1);
        },
        ...
        addCategorie() {
            ...
            this.categorie = {
                nom_categorie: '', categorie_parent: 0, description: '', photos: '',
                child_categorie: [{
                    id: 0,
                    nom_categorie: '',
                    categorie_parent: 0,
        ...
        getcategorie: function (id) {
            ...
            axios.get(this.BASE_URL + "/categorie/getid/" + id).then((response) => {
                ...
                if (response.data[0].child_categorie.length <=0){
                    this.categorie = {
                        nom_categorie: '', categorie_parent: 0, description: '', photos: '',
                        child_categorie: [response.data[0]]
                    };
                }else{
                    this.categorie = response.data[0];
