<?php
class Boncommandedetail_model extends CI_Model {

    var $table_name;
    var $rqtable_name;
    public function __construct(){
        $this->load->database();
        $this->table_name = 'bon_commande_detail';
        $this->rqtable_name = 'rq_bon_commande_detail';
    }
    ...
    public function get($param = array(), $orderBy='nom', $order = 'asc', $from, $to) {
        $this->db->select($this->rqtable_name.'.*');
